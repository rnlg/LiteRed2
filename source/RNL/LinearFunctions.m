...
LinearRule[f_,n_?(IntegerQ[#]&&Positive[#]&)]:={HoldPattern[f[a___,b_Plus,c___]]:>ReleaseHold[Hold[f[a,#,c]]&/@b]/;Length[{a}]==n-1,HoldPattern[f[a___,b_?NumQ,c___]]:>b*f[a,1,c]/;(Length[{a}]==n-1&&b=!=1),HoldPattern[f[a___,b_?NumQ d_,c___]]:>b*f[a,d,c]/;Length[{a}]==n-1};LinearRule[f_,n:{__?(IntegerQ[#]&&Positive[#]&)}]:={HoldPattern[f[a___,b_Plus,c___]]:>ReleaseHold[Hold[f[a,#,c]]&/@b]/;MemberQ[n-1,Length[{a}]],HoldPattern[f[a___,b_?NumQ,c___]]:>b*f[a,1,c]/;(MemberQ[n-1,Length[{a}]]&&b=!=1),HoldPattern[f[a___,b_?NumQ d_,c___]]:>b*f[a,d,c]/;MemberQ[n-1,Length[{a}]]};LinearRule[f_,All]:={HoldPattern[f[a___,b_Plus,c___]]:>Distribute[f[a,b,c]],HoldPattern[f[a___,b_?NumQ,c___]]:>b*f[a,1,c]/;(b=!=1),HoldPattern[f[a___,b_?NumQ d_,c___]]:>b*f[a,d,c]};LinearRule[f_,n_?(IntegerQ[#]&&Positive[#]&),test_]:={HoldPattern[f[a___,b_Plus,c___]]:>ReleaseHold[Hold[f[a,#,c]]&/@b]/;(Length[{a}]==n-1&&test[b]),HoldPattern[f[a___,b_?NumQ,c___]]:>b*f[a,1,c]/;(Length[{a}]==n-1&&test[b]&&b=!=1),HoldPattern[f[a___,b_?NumQ d_,c___]]:>b*f[a,d,c]/;(Length[{a}]==n-1&&test[b*d])};LinearRule[f_,n:{__?(IntegerQ[#]&&Positive[#]&)},test_]:={HoldPattern[f[a___,b_Plus,c___]]:>ReleaseHold[Hold[f[a,#,c]]&/@b]/;(MemberQ[n-1,Length[{a}]]&&test[b]),HoldPattern[f[a___,b_?NumQ,c___]]:>b*f[a,1,c]/;(MemberQ[n-1,Length[{a}]]&&test[b]&&b=!=1),HoldPattern[f[a___,b_?NumQ d_,c___]]:>b*f[a,d,c]/;(MemberQ[n-1,Length[{a}]]&&test[b*d])};LinearRule[f_,All,test_]:={HoldPattern[f[a___,b_Plus,c___]]:>ReleaseHold[Hold[f[a,#,c]]&/@b]/;test[b],HoldPattern[f[a___,b_?NumQ,c___]]:>b*f[a,1,c]/;(test[b]&&b=!=1),HoldPattern[f[a___,b_?NumQ d_,c___]]:>b*f[a,d,c]/;test[b*d]};
...
SetDistributive[f_,n_?(IntegerQ[#]&&Positive[#]&)]:=(LFRules=Union[LFRules,{HoldPattern[f[a___,b_Plus,c___]]:>ReleaseHold[Hold[f[a,#,c]]&/@b]/;Length[{a}]==n-1}];)
SetDistributive[f_,n:{__?(IntegerQ[#]&&Positive[#]&)}]:=(LFRules=Union[LFRules,{HoldPattern[f[a___,b_Plus,c___]]:>ReleaseHold[Hold[f[a,#,c]]&/@b]/;MemberQ[n-1,Length[{a}]]}];)
SetDistributive[f_,All]:=(LFRules=Union[LFRules,{HoldPattern[f[a___,b_Plus,c___]]:>Distribute[f[a,b,c]]}];)
SetDistributive[f_,n_?(IntegerQ[#]&&Positive[#]&),test_]:=(LFRules=Union[LFRules,{HoldPattern[f[a___,b_Plus,c___]]:>ReleaseHold[Hold[f[a,#,c]]&/@b]/;(Length[{a}]==n-1&&test[b])}];)
SetDistributive[f_,n:{__?(IntegerQ[#]&&Positive[#]&)},test_]:=(LFRules=Union[LFRules,{HoldPattern[f[a___,b_Plus,c___]]:>ReleaseHold[Hold[f[a,#,c]]&/@b]/;(MemberQ[n-1,Length[{a}]]&&test[b])}];)
SetDistributive[f_,All,test_]:=(LFRules=Union[LFRules,{HoldPattern[f[a___,b_Plus,c___]]:>ReleaseHold[Hold[f[a,#,c]]&/@b]/;test[b]}];)
