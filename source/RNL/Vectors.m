...
(*Which[*)
(*	TrueQ[$VersionNumber>=6],Notation`AutoLoadNotationPalette = False;BeginPackage["Vectors`",{"Notation`","Types`","Numbers`","LinearFunctions`"}],*)
(*	TrueQ[$VersionNumber>=5],Utilities`Notation`AutoLoadNotationPalette = False;BeginPackage["Vectors`",{"Utilities`Notation`","Types`","Numbers`","LinearFunctions`"}],*)
(*	True,Print["Mathematica 5.0 or higher is needed"]];*)
(**)
