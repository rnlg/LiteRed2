...
Options[SparxIBPReduce]={};


SparxIBPReduce[ex_,OptionsPattern[]]:=Module[{place,in,out,output={""},i,ex1,mis,jvars,jsecs,nrt,nr=0,reap,resrules={},jrules,vrules,flint},
...
jsecs=Sort[DeleteDuplicates[Flatten[Last/@Get[place<>"/jsDependencies"]]],Less];jrules=Join[SortBy[Flatten[Map[Last[Get[place<>"/"<>ToString[#]]]&,jsecs]],jComplexity@*First],resrules],"Getting rules from files..."];
jrules=FLINT`sparxGaussSolve[Subtract@@@jrules,jvars,Save->Length[resrules]];
